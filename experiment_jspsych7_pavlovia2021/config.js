...
const CONFIG = {
  ...
  // ---------------------------------------------------------------------------
  platform: {
    online: true,    // false = local testing, true = Pavlovia
  },
  ...
  calibration: {
    ...
    device_screen:   false,   // Log pixel ratio, screen size, user agent
    resize_card:     false,   // Physical screen size via credit card method
    blind_spot:      false,   // Viewing distance via blind spot method
    gamma:           false,   // Gamma estimation via alternating-pixel matching
    contrast_screen: false,   // Hidden-digit contrast check (attention gate)
    ambient_light:   false,   // Single self-report item about room lighting
  ...
  // ---------------------------------------------------------------------------
  practice: {
    enabled: true,    // Set to false to skip practice block
  ...
  // ---------------------------------------------------------------------------
  questionnaires: {
    enabled: true,    // Master switch: false = skip all questionnaires
    names: [
